...
import IntimacaoTool from './components/IntimacaoTool';
...
import AdhdTool from './components/AdhdTool';
...
const App: React.FC = () => {
  ...
  const renderScreen = () => {
    switch (currentScreen) {
      ...
      case 'INTIMACAO': return <IntimacaoTool people={people} caseData={caseData} promotorias={promotorias} />;
      ...
      case 'ADHD_TOOLS': return <AdhdTool />;
